...
Monaco behaviours worth knowing before changing anything. For the lessons that generalise beyond this
package, see [TRANSPOSE.md](TRANSPOSE.md) (the C#-to-JavaScript seam) and [TESSERAE.md](TESSERAE.md) (the
framework); both are indexed by symptom.
